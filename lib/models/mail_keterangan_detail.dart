class MailKeteranganDetailService {
  Rt? rt;
  Rw? rw;
  Surat? surat;
  SuratBody? suratBody;
  ...
  MailKeteranganDetailService({this.rt, this.rw, this.surat, this.suratBody, this.trackings});

  MailKeteranganDetailService.fromJson(Map<String, dynamic> json) {
...
class SuratBody {
  ...
  SuratBody.fromJson(Map<String, dynamic> json) {
    ...
    jenisSuratKeteranganId = json['jenis_surat_keterangan_id'];
    nik = json['nik'];
    nama = json['nama'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['jenis_surat_keterangan_id'] = this.jenisSuratKeteranganId;
    data['nik'] = this.nik;
    data['nama'] = this.nama;
